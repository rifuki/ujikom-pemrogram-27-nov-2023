    ...
    <div class="m-5 d-flex justify-content-center">
        <div class="card w-50">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="/guru/{{ $guru->nip}}" method="POST">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <input class="form-control @error('nm_guru') is-invalid @enderror" type="text" name="nm_guru" value=" {{ old('nm_guru', $guru->nm_guru) }}">
                            @error('nm_guru')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <input class="form-control @error('tmp_lahir_guru') is-invalid @enderror" type="text" name="tmp_lahir_guru" value="{{ old('tmp_lahir_guru', $guru->nm_guru) }}">
                            @error('tmp_lahir')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <input class="form-control @error('tgl_lahir_guru') is-invalid @enderror" type="date" name="tgl_lahir_guru" value="{{ old('tgl_lahir_guru', $guru->tgl_lahir_guru) }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9 d-flex align-items-center gap-5">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jkel_guru" value="L" {{ ($guru->jkel_guru == 'L' || old('jkel_guru') == 'P') ? 'checked' : '' }}>
                                <label class="form-check-label">Laki-laki</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jkel_guru" value="P" {{ ($guru->jkel_guru == 'P' || old('jkel_guru') == 'L') ? 'checked' : ''  }}>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <input class="form-control @error('alamat') is-invalid @enderror" type="text" name="alamat" value="{{ old('alamat', $guru->alamat) }}">
                            @error('alamat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <input class="form-control @error('telp') is-invalid @enderror" type="text" name="telp" value="{{ old('telp', $guru->telp) }}">
                            @error('telp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
